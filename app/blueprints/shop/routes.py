...
@shop.route('/')
@login_required  #Required login to access the marketplace 
def get_products():
    context = {
...
def add_to_cart():
    ...
    flash(f'{p.name} has been added to your cart') #f[ormat] string message to alert user about added item 
...
def remove_from_cart():
    ...
    for item in session['cart']['items']:
        if _id == item['id']:
            ...
            flash('You have removed {} from your cart'.format(item['name']), 'danger')
            break
